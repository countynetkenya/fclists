// FClist Receiving — line-level goods-received register filters. QB-POS "Received Items" parity.
// Companies (2026-07-17): tree-checkbox MultiSelectList yokoten — see fclist_gl.js's header comment for
// the full pattern-source note. No Cost Centre filter this wave — see fclist_receiving.py's docstring.
...
// controller already reads (supplier / item / window_days / from_date / to_date).
frappe.query_reports["FClist Receiving"] = {
	filters: [
		{
			fieldname: "companies",
